...
// Vaciar base de datos si existe
$sql = "DROP DATABASE IF  EXISTS laforja;";
if ($conn->query($sql) === TRUE) {
    echo "Base de datos previa borrada";
} else {
    echo "Error borrando la base de datos previa: " . $conn->error;
}
